...
export const OverviewView: React.FC<OverviewViewProps> = ({
  ...
  const consumedProtein = allLoggedItems.reduce(
    (sum, item) => sum + item.protein,
    0,
  );
  const consumedCarbs = allLoggedItems.reduce(
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-[#444748]/20 pb-4"
      >
        <div>
          ...
          <p className="font-body-md text-sm text-[#c4c7c7] mt-0.5">
            Welcome back, {userProfile.name}. Your daily nutrition targets are
            on track.
          </p>
        </div>
      ...
      >
        ...
        <div className="w-full md:w-1/3 flex flex-col gap-6 md:-ml-28 relative z-10 pb-4">
          ...
          <p className="font-body-md text-[#c4c7c7] font-light leading-relaxed">
            Plan your meals, track what you eat, and understand your macro
          ...
          <div className="flex flex-col gap-1 md:pr-8">
            ...
            <div className="w-full bg-[#201f1f] h-1 rounded-sm overflow-hidden mt-3 relative">
              <motion.div
                ...
                initial={{ width: 0 }}
                animate={{
                  width: `${Math.min(100, (consumedKcal / userProfile.targetKcal) * 100)}%`,
                }}
          ...
          <div className="flex flex-col gap-1 md:px-8">
            ...
            <div className="w-full bg-[#201f1f] h-1 rounded-sm overflow-hidden mt-3 relative">
              <motion.div
                ...
                initial={{ width: 0 }}
                animate={{
                  width: `${Math.min(100, (consumedProtein / userProfile.targetProtein) * 100)}%`,
                }}
                transition={{ duration: 1, ease: "easeOut" }}
              />
            </div>
          ...
          <div className="flex flex-col gap-1 md:px-8">
            ...
            <div className="w-full bg-[#201f1f] h-1 rounded-sm overflow-hidden mt-3 relative">
              <motion.div
                ...
                initial={{ width: 0 }}
                animate={{
                  width: `${Math.min(100, (consumedCarbs / userProfile.targetCarbs) * 100)}%`,
                }}
                transition={{ duration: 1, ease: "easeOut" }}
              />
            </div>
          ...
          <div className="flex flex-col gap-1 md:pl-8">
            ...
            <div className="w-full bg-[#201f1f] h-1 rounded-sm overflow-hidden mt-3 relative">
              <motion.div
                ...
                initial={{ width: 0 }}
                animate={{
                  width: `${Math.min(100, (consumedFat / userProfile.targetFat) * 100)}%`,
                }}
                transition={{ duration: 1, ease: "easeOut" }}
              />
            </div>
      ...
      <motion.section
        variants={sectionVariants}
        className="border-t border-[#444748]/20 pt-8 pb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-6"
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            <h4 className="text-[14px] font-medium text-[#e5e2e1]">
              Hydration & Daily Notes
            </h4>
            <p className="text-[13px] text-[#c4c7c7]">
              Remember to maintain optimal electrolyte balance alongside your
              scheduled protein targets.
            </p>
          </div>
        </div>
